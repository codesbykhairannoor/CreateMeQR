...
export default function EmbedWidgetModal({ onClose }) {
  ...
  const embedCode = `<iframe src="https://www.cratemy-qr.com" width="100%" height="800" frameborder="0" scrolling="no" style="border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"></iframe>\n<div style="text-align: center; font-size: 11px; margin-top: 8px;">Powered by <a href="https://www.cratemy-qr.com" target="_blank" style="color: #2563eb; text-decoration: none;">CreateMy-QR Generator</a></div>`;
