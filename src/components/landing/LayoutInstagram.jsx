    ...
    <div className="hq-layout-instagram">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-instagram div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-instagram div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-instagram div[class*="-hero"] {
          ...
          .hq-layout-instagram div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-instagram div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-instagram div[style*="flexDirection: 'row'"], .hq-layout-instagram div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }
          ...
          .hq-layout-instagram div[class*="-main"], .hq-layout-instagram div[class*="-wrapper"], .hq-layout-instagram div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-instagram h1, .hq-layout-instagram h2, .hq-layout-instagram h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
