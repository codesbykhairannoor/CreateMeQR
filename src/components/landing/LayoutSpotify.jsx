    ...
    <div className="hq-layout-spotify">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-spotify div[class*="-phone"], .hq-layout-spotify div[class*="-player"], .hq-layout-spotify div[class*="-mockup"], .hq-layout-spotify div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-spotify div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-spotify div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-spotify div[class*="-hero"] {
          ...
          .hq-layout-spotify div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-spotify div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-spotify div[style*="flexDirection: 'row'"], .hq-layout-spotify div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-spotify div[class*="-bento"], .hq-layout-spotify div[class*="-features"], .hq-layout-spotify div[class*="-grid"], .hq-layout-spotify div[class*="-row"], .hq-layout-spotify div[class*="bento"], .hq-layout-spotify div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-spotify div[class*="-main"], .hq-layout-spotify div[class*="-wrapper"], .hq-layout-spotify div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-spotify h1, .hq-layout-spotify h2, .hq-layout-spotify h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
