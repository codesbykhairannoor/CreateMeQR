    ...
    <div className="hq-layout-text">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-text div[class*="-hero"], .hq-layout-text div[class*="-main"], .hq-layout-text div[class*="-wrapper"], .hq-layout-text div[class*="main"] {
          ...
          .hq-layout-text h1, .hq-layout-text h2, .hq-layout-text h3, .hq-layout-text p {
