    ...
    <div className="hq-layout-d">
      ...
      <div className="hq-container">
        ...
        <div style={{ paddingBottom: 120 }}>
          <h2 style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 900, textAlign: 'center', marginBottom: 60, letterSpacing: '-0.04em', color: 'var(--hq-accent)' }}>
            {t.faqTitle} {typeName}
          </h2>
            ...
            {[
              ...
              <div key={i} style={{ borderBottom: '1px solid var(--hq-border)' }}>
                ...
                >
                  ...
                  <span style={{ color: 'var(--hq-text-muted)' }}><IconChevronDown open={openFaq === i} /></span>
                </button>
