    ...
    <div className="hq-layout-greview">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-googlereview div[class*="-phone"], .hq-layout-googlereview div[class*="-player"], .hq-layout-googlereview div[class*="-mockup"], .hq-layout-googlereview div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-googlereview div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-googlereview div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-googlereview div[class*="-hero"] {
          ...
          .hq-layout-googlereview div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-googlereview div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-googlereview div[style*="flexDirection: 'row'"], .hq-layout-googlereview div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-googlereview div[class*="-bento"], .hq-layout-googlereview div[class*="-features"], .hq-layout-googlereview div[class*="-grid"], .hq-layout-googlereview div[class*="-row"], .hq-layout-googlereview div[class*="bento"], .hq-layout-googlereview div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-googlereview div[class*="-main"], .hq-layout-googlereview div[class*="-wrapper"], .hq-layout-googlereview div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-googlereview h1, .hq-layout-googlereview h2, .hq-layout-googlereview h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
