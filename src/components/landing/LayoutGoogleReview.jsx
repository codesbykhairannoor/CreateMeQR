    ...
    <div className="hq-layout-greview">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-googlereview div[class*="-hero"], .hq-layout-googlereview div[class*="-main"], .hq-layout-googlereview div[class*="-wrapper"], .hq-layout-googlereview div[class*="main"] {
