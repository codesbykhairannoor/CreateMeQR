  ...
  return (
    <div className="hq-layout-phone">
      <style>{`
        ...
        .hq-swiss-hero { margin-bottom: 60px; border-bottom: 2px solid var(--hq-text); padding-bottom: 40px; }
        .hq-swiss-hero h2 {
        ...
        .hq-swiss-grid {
          display: grid; grid-template-columns: repeat(3, 1fr); gap: 80px; margin-bottom: 60px;
        }
        ...
        .hq-swiss-steps { margin-bottom: 60px; }
        .hq-swiss-step {
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-phone .hq-container { padding: 0 16px !important; gap: 24px !important; }
          
          /* Phone/Player Mockups scaling */
          .hq-layout-phone div[class*="-phone"], .hq-layout-phone div[class*="-player"], .hq-layout-phone div[class*="-mockup"], .hq-layout-phone div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-phone div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-phone div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-phone div[class*="-hero"] {
          ...
          .hq-layout-phone div.hq-li-avatar, .hq-layout-phone div[class*="-avatar"] {
            width: 80px !important;
            height: 80px !important;
            top: -40px !important;
          }
          .hq-layout-phone div.hq-li-profile-info, .hq-layout-phone div[class*="-profile-info"] {
            margin-top: 50px !important;
          }
          .hq-layout-phone div.hq-li-cover { height: 100px !important; }
          
          /* Fix Inline Grids (URL, WiFi, etc) that don't use CSS classes */
          .hq-layout-phone div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-phone div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-phone div[style*="flexDirection: 'row'"], .hq-layout-phone div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-phone div[class*="-bento"], .hq-layout-phone div[class*="-features"], .hq-layout-phone div[class*="-grid"], .hq-layout-phone div[class*="-row"], .hq-layout-phone div[class*="bento"], .hq-layout-phone div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-phone div[class*="-main"], .hq-layout-phone div[class*="-wrapper"], .hq-layout-phone div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-phone h1, .hq-layout-phone h2, .hq-layout-phone h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
      ...
      <div className="hq-container">
        ...
        <div className="hq-swiss-grid">
          <div className="hq-swiss-card" style={{ borderTop: '4px solid var(--hq-text)', borderRadius: 0, background: 'transparent' }}>
            ...
            <h3 className="font-bold tracking-tighter " style={{ fontSize: 24,   marginBottom: 16 }}>{translate('featTools.phone.t1') || t.comp1Title}</h3>
          ...
          <div className="hq-swiss-card" style={{ borderTop: '4px solid var(--hq-text)', borderRadius: 0, background: 'transparent' }}>
            ...
            <h3 className="font-bold tracking-tighter " style={{ fontSize: 24,   marginBottom: 16 }}>{translate('featTools.phone.t2') || t.comp2Title}</h3>
          ...
          <div className="hq-swiss-card" style={{ borderTop: '4px solid var(--hq-text)', borderRadius: 0, background: 'transparent' }}>
            ...
            <h3 className="font-bold tracking-tighter " style={{ fontSize: 24,   marginBottom: 16 }}>{translate('featTools.phone.t3') || t.comp3Title}</h3>
        ...
        <div className="hq-swiss-steps">
          <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 40 }}>
            <h2 className="font-bold tracking-tighter " style={{ fontSize: 40 }}>{t.stepsTitle}</h2>
            <ArrowRight size={40} />
          </div>
          {[
