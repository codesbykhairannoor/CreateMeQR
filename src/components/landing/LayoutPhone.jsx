    ...
    <div className="hq-layout-phone">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-phone div[class*="-hero"], .hq-layout-phone div[class*="-main"], .hq-layout-phone div[class*="-wrapper"], .hq-layout-phone div[class*="main"] {
          ...
          .hq-layout-phone h1, .hq-layout-phone h2, .hq-layout-phone h3, .hq-layout-phone p {
