    ...
    <div className="hq-layout-venmo">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-venmo div[class*="-hero"], .hq-layout-venmo div[class*="-main"], .hq-layout-venmo div[class*="-wrapper"], .hq-layout-venmo div[class*="main"] {
      ...
      <div className="hq-container">
        ...
        <div style={{ paddingBottom: 100 }}>
          <h2 className="font-bold tracking-tighter " style={{ paddingTop: 0, fontSize: 24,  textAlign: 'center', marginBottom: 32 }}>{t.faqTitle}</h2>
