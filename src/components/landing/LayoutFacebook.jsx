    ...
    <div className="hq-layout-facebook">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-facebook div[class*="-phone"], .hq-layout-facebook div[class*="-player"], .hq-layout-facebook div[class*="-mockup"], .hq-layout-facebook div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-facebook div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-facebook div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-facebook div[class*="-hero"] {
          ...
          .hq-layout-facebook div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-facebook div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-facebook div[style*="flexDirection: 'row'"], .hq-layout-facebook div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-facebook div[class*="-bento"], .hq-layout-facebook div[class*="-features"], .hq-layout-facebook div[class*="-grid"], .hq-layout-facebook div[class*="-row"], .hq-layout-facebook div[class*="bento"], .hq-layout-facebook div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-facebook div[class*="-main"], .hq-layout-facebook div[class*="-wrapper"], .hq-layout-facebook div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-facebook h1, .hq-layout-facebook h2, .hq-layout-facebook h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
