    ...
    <div className="hq-layout-tiktok">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-tiktok div[class*="-phone"], .hq-layout-tiktok div[class*="-player"], .hq-layout-tiktok div[class*="-mockup"], .hq-layout-tiktok div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-tiktok div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-tiktok div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-tiktok div[class*="-hero"] {
          ...
          .hq-layout-tiktok div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-tiktok div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-tiktok div[style*="flexDirection: 'row'"], .hq-layout-tiktok div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-tiktok div[class*="-bento"], .hq-layout-tiktok div[class*="-features"], .hq-layout-tiktok div[class*="-grid"], .hq-layout-tiktok div[class*="-row"], .hq-layout-tiktok div[class*="bento"], .hq-layout-tiktok div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-tiktok div[class*="-main"], .hq-layout-tiktok div[class*="-wrapper"], .hq-layout-tiktok div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-tiktok h1, .hq-layout-tiktok h2, .hq-layout-tiktok h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
