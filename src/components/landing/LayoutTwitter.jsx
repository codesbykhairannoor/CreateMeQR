    ...
    <div className="hq-layout-twitter">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-twitter div[class*="-hero"], .hq-layout-twitter div[class*="-main"], .hq-layout-twitter div[class*="-wrapper"], .hq-layout-twitter div[class*="main"] {
          ...
          .hq-layout-twitter h1, .hq-layout-twitter h2, .hq-layout-twitter h3, .hq-layout-twitter p {
