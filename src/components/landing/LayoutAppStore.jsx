    ...
    <div className="hq-layout-appstore">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-appstore div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-appstore div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-appstore div[class*="-hero"] {
          ...
          .hq-layout-appstore div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-appstore div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-appstore div[style*="flexDirection: 'row'"], .hq-layout-appstore div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }
          ...
          .hq-layout-appstore div[class*="-main"], .hq-layout-appstore div[class*="-wrapper"], .hq-layout-appstore div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-appstore h1, .hq-layout-appstore h2, .hq-layout-appstore h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
