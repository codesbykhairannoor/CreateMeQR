      ...
      <div className="hq-aud-wrapper">
        ...
        <div className="hq-aud-features">
          <div className="hq-aud-feat">
            <Headphones size={40} />
            <div>
              <h3 className="font-bold tracking-tighter text-zinc-900 dark:text-white" style={{ fontSize: 28,  marginBottom: 12 }}>{getTranslation('featTools', 't', 1)}</h3>
          ...
          <div className="hq-aud-feat">
            <Radio size={40} />
            <div>
              <h3 className="font-bold tracking-tighter text-zinc-900 dark:text-white" style={{ fontSize: 28,  marginBottom: 12 }}>{getTranslation('featTools', 't', 2)}</h3>
          ...
          <div className="hq-aud-feat">
            <Volume2 size={40} />
            <div>
              <h3 className="font-bold tracking-tighter text-zinc-900 dark:text-white" style={{ fontSize: 28,  marginBottom: 12 }}>{getTranslation('featTools', 't', 3)}</h3>
