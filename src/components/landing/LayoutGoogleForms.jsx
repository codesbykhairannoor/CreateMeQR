    ...
    <div className="hq-layout-gforms">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-googleforms div[class*="-hero"], .hq-layout-googleforms div[class*="-main"], .hq-layout-googleforms div[class*="-wrapper"], .hq-layout-googleforms div[class*="main"] {
          ...
          .hq-layout-googleforms h1, .hq-layout-googleforms h2, .hq-layout-googleforms h3, .hq-layout-googleforms p {
      ...
      <div className="hq-gf-wrapper">
        ...
        <div style={{ marginTop: 80 }}>
          <h2 className="font-bold tracking-tighter " style={{ paddingTop: 0, fontSize: 28,  textAlign: 'center', marginBottom: 40 }}>{t('landing.faqTitle')}</h2>
