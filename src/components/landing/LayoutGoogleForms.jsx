    ...
    <div className="hq-layout-gforms">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-googleforms .hq-container { padding: 0 16px !important; gap: 24px !important; }
          
          /* Phone/Player Mockups scaling */
          .hq-layout-googleforms div[class*="-phone"], .hq-layout-googleforms div[class*="-player"], .hq-layout-googleforms div[class*="-mockup"], .hq-layout-googleforms div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-googleforms div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-googleforms div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-googleforms div[class*="-hero"] {
          ...
          .hq-layout-googleforms div.hq-li-avatar, .hq-layout-googleforms div[class*="-avatar"] {
            width: 80px !important;
            height: 80px !important;
            top: -40px !important;
          }
          .hq-layout-googleforms div.hq-li-profile-info, .hq-layout-googleforms div[class*="-profile-info"] {
            margin-top: 50px !important;
          }
          .hq-layout-googleforms div.hq-li-cover { height: 100px !important; }
          
          /* Fix Inline Grids (URL, WiFi, etc) that don't use CSS classes */
          .hq-layout-googleforms div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-googleforms div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-googleforms div[style*="flexDirection: 'row'"], .hq-layout-googleforms div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-googleforms div[class*="-bento"], .hq-layout-googleforms div[class*="-features"], .hq-layout-googleforms div[class*="-grid"], .hq-layout-googleforms div[class*="-row"], .hq-layout-googleforms div[class*="bento"], .hq-layout-googleforms div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-googleforms div[class*="-main"], .hq-layout-googleforms div[class*="-wrapper"], .hq-layout-googleforms div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-googleforms h1, .hq-layout-googleforms h2, .hq-layout-googleforms h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
