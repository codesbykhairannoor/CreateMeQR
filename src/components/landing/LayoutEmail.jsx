    ...
    <div className="hq-layout-email">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-email div[class*="-hero"], .hq-layout-email div[class*="-main"], .hq-layout-email div[class*="-wrapper"], .hq-layout-email div[class*="main"] {
          ...
          .hq-layout-email h1, .hq-layout-email h2, .hq-layout-email h3, .hq-layout-email p {
