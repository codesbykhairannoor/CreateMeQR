    ...
    <div className="hq-layout-email">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-email .hq-container { padding: 0 16px !important; gap: 24px !important; }
          
          /* Phone/Player Mockups scaling */
          .hq-layout-email div[class*="-phone"], .hq-layout-email div[class*="-player"], .hq-layout-email div[class*="-mockup"], .hq-layout-email div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-email div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-email div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-email div[class*="-hero"] {
          ...
          .hq-layout-email div.hq-li-avatar, .hq-layout-email div[class*="-avatar"] {
            width: 80px !important;
            height: 80px !important;
            top: -40px !important;
          }
          .hq-layout-email div.hq-li-profile-info, .hq-layout-email div[class*="-profile-info"] {
            margin-top: 50px !important;
          }
          .hq-layout-email div.hq-li-cover { height: 100px !important; }
          
          /* Fix Inline Grids (URL, WiFi, etc) that don't use CSS classes */
          .hq-layout-email div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-email div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-email div[style*="flexDirection: 'row'"], .hq-layout-email div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-email div[class*="-bento"], .hq-layout-email div[class*="-features"], .hq-layout-email div[class*="-grid"], .hq-layout-email div[class*="-row"], .hq-layout-email div[class*="bento"], .hq-layout-email div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-email div[class*="-main"], .hq-layout-email div[class*="-wrapper"], .hq-layout-email div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-email h1, .hq-layout-email h2, .hq-layout-email h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
