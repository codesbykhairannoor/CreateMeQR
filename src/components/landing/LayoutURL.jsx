    ...
    <div className="hq-layout-url">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-url div[class*="-phone"], .hq-layout-url div[class*="-player"], .hq-layout-url div[class*="-mockup"], .hq-layout-url div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-url div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-url div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-url div[class*="-hero"] {
          ...
          .hq-layout-url div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-url div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-url div[style*="flexDirection: 'row'"], .hq-layout-url div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-url div[class*="-bento"], .hq-layout-url div[class*="-features"], .hq-layout-url div[class*="-grid"], .hq-layout-url div[class*="-row"], .hq-layout-url div[class*="bento"], .hq-layout-url div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-url div[class*="-main"], .hq-layout-url div[class*="-wrapper"], .hq-layout-url div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-url h1, .hq-layout-url h2, .hq-layout-url h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
