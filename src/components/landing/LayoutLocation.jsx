    ...
    <div className="hq-layout-loc">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-location div[class*="-hero"], .hq-layout-location div[class*="-main"], .hq-layout-location div[class*="-wrapper"], .hq-layout-location div[class*="main"] {
          ...
          .hq-layout-location h1, .hq-layout-location h2, .hq-layout-location h3, .hq-layout-location p {
