    ...
    <div className="hq-layout-sms">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-sms div[class*="-phone"], .hq-layout-sms div[class*="-player"], .hq-layout-sms div[class*="-mockup"], .hq-layout-sms div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-sms div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-sms div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-sms div[class*="-hero"] {
          ...
          .hq-layout-sms div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-sms div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-sms div[style*="flexDirection: 'row'"], .hq-layout-sms div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-sms div[class*="-bento"], .hq-layout-sms div[class*="-features"], .hq-layout-sms div[class*="-grid"], .hq-layout-sms div[class*="-row"], .hq-layout-sms div[class*="bento"], .hq-layout-sms div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-sms div[class*="-main"], .hq-layout-sms div[class*="-wrapper"], .hq-layout-sms div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-sms h1, .hq-layout-sms h2, .hq-layout-sms h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
