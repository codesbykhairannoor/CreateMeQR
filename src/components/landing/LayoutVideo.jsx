    ...
    <div className="hq-layout-video">
      ...
      <div className="hq-vid-features">
        <div className="hq-vid-feat">
          <PlayCircle size={40} />
          <h3 style={{ fontSize: 24, fontWeight: 700, marginBottom: 16 }}>{getTranslation('featTools', 't', 1)}</h3>
          <p style={{ color: 'var(--hq-text-muted)', fontSize: 16, lineHeight: 1.6 }}>{getTranslation('featTools', 'd', 1)}</p>
        </div>
        <div className="hq-vid-feat">
          <Maximize size={40} />
          <h3 style={{ fontSize: 24, fontWeight: 700, marginBottom: 16 }}>{getTranslation('featTools', 't', 2)}</h3>
          <p style={{ color: 'var(--hq-text-muted)', fontSize: 16, lineHeight: 1.6 }}>{getTranslation('featTools', 'd', 2)}</p>
        </div>
        <div className="hq-vid-feat">
          <Smartphone size={40} />
          <h3 style={{ fontSize: 24, fontWeight: 700, marginBottom: 16 }}>{getTranslation('featTools', 't', 3)}</h3>
