    ...
    <div className="hq-layout-video">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-video div[class*="-hero"], .hq-layout-video div[class*="-main"], .hq-layout-video div[class*="-wrapper"], .hq-layout-video div[class*="main"] {
          ...
          .hq-layout-video h1, .hq-layout-video h2, .hq-layout-video h3, .hq-layout-video p {
