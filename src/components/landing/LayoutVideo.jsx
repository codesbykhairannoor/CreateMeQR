    ...
    <div className="hq-layout-video">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-video .hq-container { padding: 0 16px !important; gap: 24px !important; }
          
          /* Phone/Player Mockups scaling */
          .hq-layout-video div[class*="-phone"], .hq-layout-video div[class*="-player"], .hq-layout-video div[class*="-mockup"], .hq-layout-video div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-video div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-video div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-video div[class*="-hero"] {
          ...
          .hq-layout-video div.hq-li-avatar, .hq-layout-video div[class*="-avatar"] {
            width: 80px !important;
            height: 80px !important;
            top: -40px !important;
          }
          .hq-layout-video div.hq-li-profile-info, .hq-layout-video div[class*="-profile-info"] {
            margin-top: 50px !important;
          }
          .hq-layout-video div.hq-li-cover { height: 100px !important; }
          
          /* Fix Inline Grids (URL, WiFi, etc) that don't use CSS classes */
          .hq-layout-video div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-video div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-video div[style*="flexDirection: 'row'"], .hq-layout-video div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-video div[class*="-bento"], .hq-layout-video div[class*="-features"], .hq-layout-video div[class*="-grid"], .hq-layout-video div[class*="-row"], .hq-layout-video div[class*="bento"], .hq-layout-video div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-video div[class*="-main"], .hq-layout-video div[class*="-wrapper"], .hq-layout-video div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-video h1, .hq-layout-video h2, .hq-layout-video h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
