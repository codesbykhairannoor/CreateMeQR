    ...
    <div className="hq-layout-discord">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-discord div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-discord div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-discord div[class*="-hero"] {
          ...
          .hq-layout-discord div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-discord div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-discord div[style*="flexDirection: 'row'"], .hq-layout-discord div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }
          ...
          .hq-layout-discord div[class*="-main"], .hq-layout-discord div[class*="-wrapper"], .hq-layout-discord div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-discord h1, .hq-layout-discord h2, .hq-layout-discord h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
