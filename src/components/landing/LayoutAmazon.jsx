        ...
        <div className="hq-amz-bento">
          <div className="hq-amz-card" style={{ gridColumn: 'span 2' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              ...
              <h2 style={{ fontSize: 24, fontWeight: 700, margin: 0 }}>{getTranslation('featTools', 't', 1)}</h2>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            <div className="hq-amz-card" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>{getTranslation('featTools', 't', 2)}</h3>
            ...
            <div className="hq-amz-card" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>{getTranslation('featTools', 't', 3)}</h3>
