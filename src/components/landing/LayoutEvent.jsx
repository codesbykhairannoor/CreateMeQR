    ...
    <div className="hq-layout-event">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-event div[class*="-phone"], .hq-layout-event div[class*="-player"], .hq-layout-event div[class*="-mockup"], .hq-layout-event div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-event div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-event div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-event div[class*="-hero"] {
          ...
          .hq-layout-event div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-event div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-event div[style*="flexDirection: 'row'"], .hq-layout-event div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-event div[class*="-bento"], .hq-layout-event div[class*="-features"], .hq-layout-event div[class*="-grid"], .hq-layout-event div[class*="-row"], .hq-layout-event div[class*="bento"], .hq-layout-event div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-event div[class*="-main"], .hq-layout-event div[class*="-wrapper"], .hq-layout-event div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-event h1, .hq-layout-event h2, .hq-layout-event h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
