    ...
    <div className="hq-layout-vcard">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-vcard div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-vcard div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-vcard div[class*="-hero"] {
          ...
          .hq-layout-vcard div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-vcard div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-vcard div[style*="flexDirection: 'row'"], .hq-layout-vcard div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }
          ...
          .hq-layout-vcard div[class*="-main"], .hq-layout-vcard div[class*="-wrapper"], .hq-layout-vcard div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-vcard h1, .hq-layout-vcard h2, .hq-layout-vcard h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
