    ...
    <div className="hq-layout-paypal">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-paypal div[class*="-hero"], .hq-layout-paypal div[class*="-main"], .hq-layout-paypal div[class*="-wrapper"], .hq-layout-paypal div[class*="main"] {
          ...
          .hq-layout-paypal h1, .hq-layout-paypal h2, .hq-layout-paypal h3, .hq-layout-paypal p {
