    ...
    <div className="hq-layout-paypal">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-paypal .hq-container { padding: 0 16px !important; gap: 24px !important; }
          
          /* Phone/Player Mockups scaling */
          .hq-layout-paypal div[class*="-phone"], .hq-layout-paypal div[class*="-player"], .hq-layout-paypal div[class*="-mockup"], .hq-layout-paypal div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-paypal div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-paypal div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-paypal div[class*="-hero"] {
          ...
          .hq-layout-paypal div.hq-li-avatar, .hq-layout-paypal div[class*="-avatar"] {
            width: 80px !important;
            height: 80px !important;
            top: -40px !important;
          }
          .hq-layout-paypal div.hq-li-profile-info, .hq-layout-paypal div[class*="-profile-info"] {
            margin-top: 50px !important;
          }
          .hq-layout-paypal div.hq-li-cover { height: 100px !important; }
          
          /* Fix Inline Grids (URL, WiFi, etc) that don't use CSS classes */
          .hq-layout-paypal div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-paypal div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-paypal div[style*="flexDirection: 'row'"], .hq-layout-paypal div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-paypal div[class*="-bento"], .hq-layout-paypal div[class*="-features"], .hq-layout-paypal div[class*="-grid"], .hq-layout-paypal div[class*="-row"], .hq-layout-paypal div[class*="bento"], .hq-layout-paypal div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-paypal div[class*="-main"], .hq-layout-paypal div[class*="-wrapper"], .hq-layout-paypal div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-paypal h1, .hq-layout-paypal h2, .hq-layout-paypal h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
