    ...
    <div className="hq-layout-booking">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-booking div[class*="-phone"], .hq-layout-booking div[class*="-player"], .hq-layout-booking div[class*="-mockup"], .hq-layout-booking div[class*="-mock"] {
            width: 100% !important;
          ...
          .hq-layout-booking div[class*="-phone"] { aspect-ratio: 9/18 !important; }
          
          /* Specific fix for YouTube player which should be 16:9 */
          .hq-layout-booking div.hq-yt-player { aspect-ratio: 16/9 !important; min-height: auto !important; }
          
          /* Fix Hero Padding */
          .hq-layout-booking div[class*="-hero"] {
          ...
          .hq-layout-booking div[style*="gridTemplateColumns"] {
            display: flex !important;
            flex-direction: column !important;
            gap: 24px !important;
          }
          .hq-layout-booking div[style*="gridColumn:"] {
            width: 100% !important;
            grid-column: span 1 !important;
          }
          
          /* Fix Inline Flex Rows (URL steps) */
          .hq-layout-booking div[style*="flexDirection: 'row'"], .hq-layout-booking div[style*="flex-direction: row"] {
            flex-direction: column !important;
          }

          /* Fix grid column squeezing for ALL bento, features, and grid classes */
          .hq-layout-booking div[class*="-bento"], .hq-layout-booking div[class*="-features"], .hq-layout-booking div[class*="-grid"], .hq-layout-booking div[class*="-row"], .hq-layout-booking div[class*="bento"], .hq-layout-booking div[class*="features"] {
            display: flex !important;
            flex-direction: column !important;
          }
          
          /* Ensure ALL Main and Wrapper containers stack vertically */
          .hq-layout-booking div[class*="-main"], .hq-layout-booking div[class*="-wrapper"], .hq-layout-booking div[class*="main"] {
            display: flex !important;
            flex-direction: column !important;
          }

          /* Ensure text wraps nicely */
          .hq-layout-booking h1, .hq-layout-booking h2, .hq-layout-booking h3 { line-height: 1.2 !important; word-wrap: break-word; }
        }
