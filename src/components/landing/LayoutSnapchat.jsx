    ...
    <div className="hq-layout-snapchat">
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hq-layout-snapchat div[class*="-hero"], .hq-layout-snapchat div[class*="-main"], .hq-layout-snapchat div[class*="-wrapper"], .hq-layout-snapchat div[class*="main"] {
      ...
      <div style={{ background: '#111', padding: '60px 0', paddingBottom: 160 }}>
        <div className="hq-container" style={{ maxWidth: 800 }}>
          <h2 className="font-bold tracking-tighter" style={{ paddingTop: 0, fontSize: 32,  textAlign: 'center', marginBottom: 40, color: 'white' }}>{t.faqTitle}</h2>
