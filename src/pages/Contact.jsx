  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 py-12 md:py-20 animate-fade-in-up">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter text-zinc-900 dark:text-white mb-6">
          {t('contact.title')}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-white dark:bg-[#081226] border border-blue-100 dark:border-[#102040] p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all group flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold tracking-tighter dark:text-white mb-3">{t('contact.email_support')}</h3>
        ...
        <div className="bg-white dark:bg-[#081226] border border-blue-100 dark:border-[#102040] p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all group flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold tracking-tighter dark:text-white mb-3">{t('contact.community')}</h3>
          <p className="text-zinc-600 dark:text-zinc-400 mb-6 text-sm">
        ...
        <div className="bg-white dark:bg-[#081226] border border-blue-100 dark:border-[#102040] p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all group flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold tracking-tighter dark:text-white mb-3">{t('contact.hq')}</h3>
          <p className="text-zinc-600 dark:text-zinc-400 mb-6 text-sm">
            {t('contact.hq_desc')}
          </p>
